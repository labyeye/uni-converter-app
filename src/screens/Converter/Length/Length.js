    ...
    <View style={styles.container}>
      <View style={styles.inputContainer}>
        <View style={styles.inputRow}>
          <View style={styles.circle}><Text style={styles.unitText}>{isMeterToFoot ? 'm' : 'ft'}</Text></View>
          <Text style={styles.unitName}>{isMeterToFoot ? 'Meter' : 'Foot'}</Text>
          <TextInput
        ...
        <View style={styles.inputRow}>
          <View style={styles.circle}><Text style={styles.unitText}>{isMeterToFoot ? 'ft' : 'm'}</Text></View>
          <Text style={styles.unitName}>{isMeterToFoot ? 'Foot' : 'Meter'}</Text>
          <TextInput
            style={styles.inputField}
