    ...
    <View style={styles.container}>
      <View style={styles.inputContainer}>
        <View style={styles.inputRow}>
          <View style={styles.circle}><Text style={styles.unitText}>{isMeterToFoot ? 'KJ' : 'J'}</Text></View>
          <Text style={styles.unitName}>{isMeterToFoot ? 'KiloJoules' : 'Joules'}</Text>
          <TextInput
        ...
        <View style={styles.inputRow}>
          <View style={styles.circle}><Text style={styles.unitText}>{isMeterToFoot ? 'J' : 'KJ'}</Text></View>
          <Text style={styles.unitName}>{isMeterToFoot ? 'Joules' : 'KiloJoules'}</Text>
          <TextInput
            style={styles.inputField}
