...
const Speed = () => {
  ...
  const convertMetersToFeet = (meters) => {
    const feet = (parseFloat(meters) /3.6).toFixed(4);
    return isNaN(feet) ? '' : feet;
  };

  const convertFeetToMeters = (feet) => {
    const meters = (parseFloat(feet)*3.6).toFixed(4);
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.inputContainer}>
        <View style={styles.inputRow}>
          <View style={styles.circle}><Text style={styles.unitText}>{isMeterToFoot ? 'kmh' : 'mps'}</Text></View>
          <Text style={styles.unitName}>{isMeterToFoot ? 'Kilometer Per Hr' : 'Miles Per Sec'}</Text>
          <TextInput
        ...
        <View style={styles.inputRow}>
          <View style={styles.circle}><Text style={styles.unitText}>{isMeterToFoot ? 'mps' : 'kmh'}</Text></View>
          <Text style={styles.unitName}>{isMeterToFoot ? 'Miles Per Sec' : 'Kilometer Per Hr'}</Text>
          <TextInput
            style={styles.inputField}
