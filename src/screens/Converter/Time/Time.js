...
const Time = () => {
  ...
  const convertMetersToFeet = (meters) => {
    const feet = (parseFloat(meters)*60*60).toFixed(4);
    return isNaN(feet) ? '' : feet;
  };

  const convertFeetToMeters = (feet) => {
    const meters = (parseFloat(feet)/3600).toFixed(4);
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.inputContainer}>
        <View style={styles.inputRow}>
          ...
          <Text style={styles.unitName}>{isMeterToFoot ? 'Hour' : 'Second'}</Text>
          <TextInput
        ...
        <View style={styles.inputRow}>
          <View style={styles.circle}><Text style={styles.unitText}>{isMeterToFoot ? 'sec' : 'hr'}</Text></View>
          <Text style={styles.unitName}>{isMeterToFoot ? 'Second' : 'Hour'}</Text>
          <TextInput
            style={styles.inputField}
