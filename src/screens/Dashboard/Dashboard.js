...
const Dashboard = ({navigation}) => {
  ...
  let buttonSize =
    screenWidth <= 375 ? (screenWidth - 100) / 4 : (screenWidth - 180) / 3;

  const items = [
    {
      name: 'Unit Converter',
      icon: <ArrowPathIcon color="black" size={buttonSize / 2} />,
      navigateTo: 'ConverterStack',
    },
    {
      name: 'BMI',
      icon: <IonIcons name="body" color="black" size={buttonSize / 2} />,
      navigateTo: 'BodyMassIndex',
    },
    {
    ...
    {
      name: 'Calculator',
      icon: <CalculatorIcon color="black" size={buttonSize / 2} />,
    ...
    },
    {
      ...
      navigateTo: 'MatrixMultiplication',
    },
    {
      name: 'Multiply Inverse',
      icon: (
        <MaterialCommunityIcons
      ...
      navigateTo: 'MultiplicativeInverse',
    },
    {
      name: 'Gcd & Lcm',
      icon: (
...
const styles = StyleSheet.create({
  ...
  adContainer: {
    ...
    position: 'absolute',
    bottom: 0,
    paddingBottom: 10, // Adjust to add padding if needed
  },
});
